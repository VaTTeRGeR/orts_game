 ...
 * @author VaTTeRGeR */
public class GridMap2DSimple implements GridMap2D {
	...
	public GridMap2DSimple (int numCellsXY, int cellSizeXY, int initialBucketCapacity, float offsetX, float offsetY) {
