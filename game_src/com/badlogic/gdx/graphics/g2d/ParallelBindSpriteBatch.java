...
public class ParallelBindSpriteBatch implements Batch {
	 ...
	 * @see ParallelBindSpriteBatch#TextureArraySpriteBatch(int, ShaderProgram) */
	public ParallelBindSpriteBatch () {
		this(1000);
	}

	/** Constructs a TextureArraySpriteBatch with one buffer and the default shader.
	 * @see ParallelBindSpriteBatch#TextureArraySpriteBatch(int, ShaderProgram) */
	public ParallelBindSpriteBatch (int size) {
		this(size, null);
	}
	...
	public ParallelBindSpriteBatch (int size, ShaderProgram defaultShader) throws IllegalStateException {
	 ...
	 * {@link ParallelBindSpriteBatch#createDefaultShader(int)} for reference.
	 * <p>
